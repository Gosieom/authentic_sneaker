...
const Offers = () => {
  return (
    <section className="flex flex-col items-center bg-gradient-to-r from-yellow-100 to-pink-100 py-10 space-y-10 shadow-md rounded-md mx-4 my-6">
      <h2 className="text-4xl font-extrabold text-red-600 animate-bounce">
